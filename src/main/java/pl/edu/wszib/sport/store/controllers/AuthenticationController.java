...
import pl.edu.wszib.sport.store.exceptions.AuthValidationException;
import pl.edu.wszib.sport.store.exceptions.LoginAlreadyUseException;
import pl.edu.wszib.sport.store.exceptions.RegisterValidationException;
import pl.edu.wszib.sport.store.model.view.RegisterUser;
import pl.edu.wszib.sport.store.service.IAuthenticationService;
import pl.edu.wszib.sport.store.session.SessionObject;
import pl.edu.wszib.sport.store.validators.LoginValidator;
import pl.edu.wszib.sport.store.validators.RegisterValidator;
