...
import pl.edu.wszib.sport.store.database.IManufacturerDAO;
...
public class IManufacturerDAOImpl implements IManufacturerDAO {
    ...
    public Optional<Manufacturer> getManufacturerById(int mId) {
        ...
        Query<Manufacturer> query = session.createQuery("FROM pl.edu.wszib.sport.store.model.Manufacturer WHERE id = :id");
    ...
    public List<Manufacturer> getManufacturerByType(String mType) {
        Session session = this.sessionFactory.openSession();
        Query<Manufacturer> query = session.createQuery("FROM pl.edu.wszib.sport.store.model.Manufacturer WHERE type = :mType");
