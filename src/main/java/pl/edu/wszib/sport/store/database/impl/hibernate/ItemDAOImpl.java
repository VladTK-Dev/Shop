package pl.edu.wszib.sport.store.database.impl.hibernate;
...
public class ItemDAOImpl implements InItemDAO {
    ...
    public List<Item> getItems() {
        Session session = this.sessionFactory.openSession();
        Query<Item> query = session.createQuery("FROM pl.edu.wszib.sport.store.model.Item");
    ...
    public Optional<Item> getItemById(int itemId) {
        Session session = this.sessionFactory.openSession();
        Query<Item> query = session.createQuery("FROM pl.edu.wszib.sport.store.model.Item WHERE id = :id");
    ...
    public List<Item> getItemsByType(String type) {
        Session session = this.sessionFactory.openSession();
        Query<Item> query = session.createQuery("FROM pl.edu.wszib.sport.store.model.Item where type = :type");
    ...
    public HashSet<Item> getItemsByManufacturer(int mId) {
        Session session = this.sessionFactory.openSession();
        Query<Item> query = session.createQuery("FROM pl.edu.wszib.sport.store.model.Item where manufacturer_id = :manufacturer_id");
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (manufacturer.isEmpty())
                    manufacturer1 = new Manufacturer("temp name", Manufacturer.Type.valueOf("Snowboard"));
                else
